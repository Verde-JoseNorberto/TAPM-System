...
@section('page-content')
  <div class="container my-2">
    ...
    <a class="btn btn-outline-dark my-2" href="{{ URL::to('office/project/' . $group_projects->id . '/task') }}">
  ...
  <div class="modal-dialog">
      <div class="modal-content">
          ...
          <div class="modal-body">
              <form method="POST" action="{{ route('office/detail') }}">
              @csrf 
              @method("PUT")
  ...
  <div class="modal-content">
    ...
    <div class="tab-content">
      <div class="tab-pane fade show active" id="todo">
        @include('office.subtask', ['subtasks' => $tasks->subtasks->where('status', 'To Do'), 'task_id' => $tasks->id])
      </div>
      <div class="tab-pane fade" id="inProgress">
        @include('office.subtask', ['subtasks' => $tasks->subtasks->where('status', 'In Progress'), 'task_id' => $tasks->id])
      </div>
      <div class="tab-pane fade" id="finished">
        @include('office.subtask', ['subtasks' => $tasks->subtasks->where('status', 'Finished'), 'task_id' => $tasks->id])
      </div>
    </div>
