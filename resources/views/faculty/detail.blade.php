...
@section('page-content')
  <div class="container my-2">
    ...
    <a class="btn btn-outline-dark my-2" href="{{ URL::to('faculty/project/' . $group_projects->id . '/task') }}">
    ...
    <div class="tab-content">
      <div class="tab-pane fade show active" id="todo">
        @include('faculty.subtask', ['subtasks' => $tasks->subtasks->where('status', 'To Do'), 'task_id' => $tasks->id])
      </div>
      <div class="tab-pane fade" id="inProgress">
        @include('faculty.subtask', ['subtasks' => $tasks->subtasks->where('status', 'In Progress'), 'task_id' => $tasks->id])
      </div>
      <div class="tab-pane fade" id="finished">
        @include('faculty.subtask', ['subtasks' => $tasks->subtasks->where('status', 'Finished'), 'task_id' => $tasks->id])
      </div>
    </div>
...
<div class="modal fade" id="taskModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form method="POST" action="{{ route('faculty/subtask') }}">
          @csrf
